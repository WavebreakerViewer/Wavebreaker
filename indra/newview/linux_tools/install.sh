...
# Wavebreaker Viewer Installation Script
...
DEFAULT_SYSTEM_INSTALL_DIR="/opt/wavebreaker"
DEFAULT_USER_INSTALL_DIR="$HOME/wavebreaker"
...
# Function to install Wavebreaker Viewer to the specified directory
install_to_prefix() {
    ...
    echo " - Installing Wavebreaker Viewer to $install_prefix"
...
homedir_install() {
    ...
    warn "to install the Wavebreaker Viewer in your home directory. If you"
    warn "would like to install the Wavebreaker Viewer system-wide, please run"
...
main() {
    echo "Starting Wavebreaker Viewer installation script..."
    ...
    echo "Wavebreaker Viewer installation process completed successfully."
}
