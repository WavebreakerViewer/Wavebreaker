...
LangString DirectoryChooseUpdate ${LANG_GERMAN} "Wählen Sie den Wavebreaker Ordner für dieses Update:"
LangString DirectoryChooseSetup ${LANG_GERMAN} "Pfad in dem Wavebreaker installiert werden soll:"

LangString MUI_TEXT_DIRECTORY_TITLE ${LANG_GERMAN} "Installationsverzeichnis"
LangString MUI_TEXT_DIRECTORY_SUBTITLE ${LANG_GERMAN} "Wählen Sie das Verzeichnis aus, in dem Wavebreaker installiert werden soll:"

LangString MUI_TEXT_INSTALLING_TITLE ${LANG_GERMAN} "Wavebreaker wird installiert..."
LangString MUI_TEXT_INSTALLING_SUBTITLE ${LANG_GERMAN} "Wavebreaker wird im Verzeichnis $INSTDIR installiert"

LangString MUI_TEXT_FINISH_TITLE ${LANG_GERMAN} "Wavebreaker wird installiert"
LangString MUI_TEXT_FINISH_SUBTITLE ${LANG_GERMAN} "Wavebreaker wurde im Verzeichnis $INSTDIR installiert."

LangString MUI_TEXT_ABORT_TITLE ${LANG_GERMAN} "Installation abgebrochen"
LangString MUI_TEXT_ABORT_SUBTITLE ${LANG_GERMAN} "Wavebreaker wird nicht im Verzeichnis $INSTDIR installiert."
...
LangString InstSuccesssQuestion ${LANG_GERMAN} "Wavebreaker starten?"
...
LangString CheckWindowsVersionMB ${LANG_GERMAN} 'Wavebreaker unterstützt nur Windows Vista mit Service Pack 2 und höher.$\nEine Installation auf diesem Betriebssystem wird nicht unterstützt. Installation wird beendet...'
LangString CheckWindowsServPackMB ${LANG_GERMAN} "Es wird empfohlen, das aktuellste Service Pack des Betriebssystems für Wavebreaker zu verwenden.$\nEs ist hilftreich für Performance und Stabilität des Programms."
...
LangString CheckAdministratorInstMB ${LANG_GERMAN} 'Sie besitzen ungenügende Berechtigungen.$\nSie müssen ein "administrator" sein, um Wavebreaker installieren zu können.'

; checkifadministrator function (uninstall)
LangString CheckAdministratorUnInstDP ${LANG_GERMAN} "Überprüfung der Entfernungs-Berechtigungen ..."
LangString CheckAdministratorUnInstMB ${LANG_GERMAN} 'Sie besitzen ungenügende Berechtigungen.$\nSie müssen ein "administrator" sein, um Wavebreaker entfernen zu können..'

; checkcpuflags
LangString MissingSSE2 ${LANG_GERMAN} "Dieser PC besitzt möglicherweise keinen Prozessor mit SSE2-Unterstützung, die für die Ausführung von Wavebreaker ${VERSION_LONG} benötigt wird. Trotzdem installieren?"
...
LangString CloseSecondLifeInstDP ${LANG_GERMAN} "Warten auf die Beendigung von Wavebreaker ..."
LangString CloseSecondLifeInstMB ${LANG_GERMAN} "Wavebreaker kann nicht installiert oder ersetzt werden, wenn es bereits läuft.$\n$\nBeenden Sie, was Sie gerade tun und klicken Sie OK, um Wavebreaker zu beenden.$\nKlicken Sie ABBRECHEN, um die Installation abzubrechen."
LangString CloseSecondLifeInstRM ${LANG_GERMAN} "Wavebreaker konnte einige Dateien einer vorherigen Installation nicht entfernen."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_GERMAN} "Warten auf die Beendigung von Wavebreaker ..."
LangString CloseSecondLifeUnInstMB ${LANG_GERMAN} "Wavebreaker kann nicht entfernt werden, wenn es bereits läuft.$\n$\nBeenden Sie, was Sie gerade tun und klicken Sie OK, um Wavebreaker zu beenden.$\nKlicken Sie CANCEL, um abzubrechen."

; CheckNetworkConnection
LangString CheckNetworkConnectionDP ${LANG_GERMAN} "Prüfe Netzwerkverbindung..."

; error during installation
LangString ErrorSecondLifeInstallRetry ${LANG_GERMAN} "Wavebreaker konnte nicht korrekt installiert werden, einige Dateien wurden eventuell nicht korrekt von der Installationroutine kopiert."
LangString ErrorSecondLifeInstallSupport ${LANG_GERMAN} "Bitte laden Sie den Viewer erneut von https://www.wavebreakerviewer.org/downloads/ und versuchen Sie die Installation erneut. Sollte das Problem weiterhin bestehen, dann kontaktieren Sie unseren Support unter https://www.wavebreakerviewer.org/support/."

; ask to remove user's data files
LangString RemoveDataFilesMB ${LANG_GERMAN} "Einstellungs- und Cache-Dateien in Dokumente und Einstellungen löschen?"

; delete program files
LangString DeleteProgramFilesMB ${LANG_GERMAN} "Es existieren weiterhin Dateien in Ihrem Wavebreaker Programm-Ordner.$\n$\nDies sind möglicherweise Dateien, die sie modifiziert oder bewegt haben:$\n$INSTDIR$\n$\nMöchten Sie diese ebenfalls löschen?"

; uninstall text
LangString UninstallTextMsg ${LANG_GERMAN} "Dies wird Wavebreaker ${VERSION_LONG} von Ihrem System entfernen."
...
LangString DeleteRegistryKeysMB ${LANG_GERMAN} "Möchten Sie Wavebreaker als Standardverknüpfung zum Öffnen von Virtuelle-Welten-Protokollen entfernen?$\n$\nEs wird empfohlen, diese zu behalten, falls Sie noch andere Versionen von Wavebreaker installiert haben."

; <FS:Ansariel> Ask to create protocol handler registry entries
LangString CreateUrlRegistryEntries ${LANG_GERMAN} "Möchten Sie Wavebreaker als Standardverknüpfung zum Öffnen von Virtuelle-Welten-Protokollen festlegen?$\n$\nFalls Sie andere Versionen von Wavebreaker installiert haben, werden bereits bestehenden Verknüpfungen überschrieben."
...
LangString UnChatlogsNoticeMB ${LANG_GERMAN} "Diese Deinstallation löscht NICHT die Wavebreaker-Chatprotokolle und andere private Dateien. Sollen diese gelöscht werden, muss das Wavebreaker-Verzeichnis im Anwendungsdaten-Verzeichnis manuell gelöscht werden."
LangString UnRemovePasswordsDP ${LANG_GERMAN} "Lösche gespeicherte Wavebreaker-Passwörter."
