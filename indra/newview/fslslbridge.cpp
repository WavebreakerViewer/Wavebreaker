 ...
 * Copyright (C) 2011-2017, The Wavebreaker Project, Inc.
 *
...
{
    if (LLUUID fsCatID = gInventory.findCategoryByName(ROOT_WAVEBREAKER_FOLDER); !fsCatID.isNull())
    {
        LLInventoryModel::item_array_t* items;
        LLInventoryModel::cat_array_t* cats;
    ...
    {
        gInventory.createNewCategory(gInventory.getRootFolderID(), LLFolderType::FT_NONE, ROOT_WAVEBREAKER_FOLDER, [this, callback](const LLUUID& new_cat_id)
            {
