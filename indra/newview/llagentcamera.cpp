...
// [RLVa:KB] - @camdistmax=0 forces mouselook
    if ( (RlvActions::isRlvEnabled()) && (change_camera) && (!cameraMouselook()) && (RlvActions::isCameraForcedMouselook()) )
    {
...
// [RLVa:KB] - @camdistmax=0 forces mouselook
    if ( (RlvActions::isRlvEnabled()) && (!cameraMouselook()) && (RlvActions::isCameraForcedMouselook()) )
    {
        changeCameraToMouselook(false);
    }
// [/RLVa:KB]
...
{
    const bool rlv_forced_mouselook = (RlvActions::isRlvEnabled()) && (RlvActions::isCameraForcedMouselook());
...
{
// [RLVa:KB] - @camdistmax=0 forces mouselook
    if ( (RlvActions::isRlvEnabled()) && (RlvActions::isCameraForcedMouselook()) )
    {
        changeCameraToMouselook(false);
        return;
    }
