...
#include "llparcel.h"
// <FS:Zi> We don't use the mini location panel in Wavebreaker
...
void RlvUIEnabler::onToggleShowMinimap()
{
    ...
    LLPanel* pNetMapPanel = (pPeoplePanel) ? pPeoplePanel->getChild<LLPanel>("minimaplayout", true) : NULL;  //AO: wavebreaker specific
    ...
    LLPanel* pRadarNetMapPanel = (pRadarFloater) ? pRadarFloater->getChild<LLPanel>("minimaplayout", true) : NULL;  //AO: wavebreaker specific
