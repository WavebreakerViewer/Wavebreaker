...
const std::string LEGACY_CLIENT_LIST_URL = "http://wavebreakerviewer.com/app/client_tags/client_list_v2.xml";
    ...
    mAgentsDone(false)
{
    ...
    mBaseURL = gSavedSettings.getBOOL("FSdataQAtest") ? "http://wavebreakerviewer.com/app/fsdatatest" : "http://wavebreakerviewer.com/app/fsdata";
...
bool FSData::isWavebreakerGroup(const LLUUID& id) const
{
