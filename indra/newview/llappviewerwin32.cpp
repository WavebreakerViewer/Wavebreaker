...
#pragma message("Building with BugSplat")
    ...
    if (!is_win_7_or_below)
    {
        ...
        FS::LogfileIn = ll_convert_string_to_wide(gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Wavebreaker.log"));
        FS::LogfileOut = ll_convert_string_to_wide(gDirUtilp->getExpandedFilename(LL_PATH_DUMP, "Wavebreaker.log"));
        FS::DumpFile = ll_convert_string_to_wide(gDirUtilp->getExpandedFilename(LL_PATH_DUMP, "Wavebreaker.dmp"));
