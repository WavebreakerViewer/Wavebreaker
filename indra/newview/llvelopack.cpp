...
static std::wstring get_app_name()
{
    ...
    // <FS:TJ> Get correct Wavebreaker app name
    ...
    //}
    //return channel;
    std::wstring prefix = L"Wavebreaker";
                                    ...
                                    const std::wstring& version)
{
                        ...
                        REG_OPTION_NON_VOLATILE, KEY_WRITE, NULL, &hkey, NULL) == ERROR_SUCCESS)
    {
        ...
        RegSetValueExW(hkey, L"Publisher", 0, REG_SZ,
                      // <FS:TJ> Use Wavebreaker installation information
                      //(BYTE*)L"Linden Research, Inc.", 44);
                      (BYTE*)L"The Wavebreaker Project, Inc.", 72);
                      // </FS:TJ>
        ...
        std::wstring link_url = L"https://www.wavebreakerviewer.org/support";
        // </FS:TJ>
        ...
        link_url = L"https://www.wavebreakerviewer.org";
        // </FS:TJ>
        ...
        link_url = L"https://www.wavebreakerviewer.org/downloads";
        // </FS:TJ>
