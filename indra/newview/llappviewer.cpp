...
// <FS>
    ...
    if (clear_file.isExist(clear_settings_filename))
    {
        ...
        // Alphabetised
        LLFile::remove(gDirUtilp->getExpandedFilename(LL_PATH_USER_SETTINGS, "account_settings_wavebreaker.xml"));
...
#endif
// </FS:Beq>
        nd::etw::logFrame(); // <FS:ND> Write the start of each frame. Even if our Provider (Wavebreaker) would be enabled, this has only light impact. Does nothing on OSX and Linux.
        {
...
void errorCallback(LLError::ELevel level, const std::string &error_string)
{
    if (level == LLError::LEVEL_ERROR)
    {
        ...
        {
            error_display_string = "We are sorry, but Wavebreaker has crashed and needs to be closed. If you see this issue happening repeatedly, please contact our support team and submit the following message:\n\n[ERROR_DETAILS]";
    ...
    if (!success)
    {
        ...
        if (gDirUtilp->fileExists(settings_file_list))
        {
            LL_ERRS() << "Cannot load default configuration file settings_files.xml. "
                << "Please reinstall viewer from https://www.wavebreakerviewer.org/choose-your-platform/ "
                << "and contact https://www.wavebreakerviewer.org/support if issue persists after reinstall."
                << LL_ENDL;
        }
        else
        {
...
//  LLFirstUse::addConfigVariable("FirstMedia");
    ...
    if (gSavedSettings.getBOOL("FirstRunThisInstall"))
    {
        ...
        {
            gSavedSettings.setString("SessionSettingsFile", "settings_wavebreaker.xml");
        }
        // </FS>
...
// </FS:Beq>
    ...
    // <FS:AO> Re-read user settings again. This is a Wavebreaker hack to get user settings to override modes
...
//                               gSavedSettings.getString("Language"));
    ...
    // injection and steal passwords. Wavebreaker. SL-55321
    ...
    //<FS:AW set the APP_NAME to Wavebreaker instead of the grid connected to>
...
// </FS:CR>
    ...
    // <FS:Ansariel> FIRE-13993: Create URL in the form of https://wiki.wavebreakerviewer.org/wavebreaker_change_log_x.y.z.rev
...
void LLAppViewer::writeSystemInfo()
{
    ...
    // <FS:ND> we don't want this (otherwise set filename to Wavebreaker.old/log)
//#if LL_DARWIN
...
void LLAppViewer::badNetworkHandler()
{
    ...
    message <<
        ...
        "www.wavebreakerviewer.org/support";
...
void LLAppViewer::disconnectViewer()
{
    ...
    // <FS:Ansariel> Wavebreaker radar: Shutdown radar
