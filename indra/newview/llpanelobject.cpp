...
//KC: Wavebreaker capability
    ...
    //KC: Wavebreaker capability, allow all transforms
...
void LLPanelObject::activateMeshFields(LLViewerObject* objectp)
{
    ...
    factor = 1.25f; // LL default for most people http://wiki.wavebreakerviewer.org/support:whirly_fizzle#lod_comparison
