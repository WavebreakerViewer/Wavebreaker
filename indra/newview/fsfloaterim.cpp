        ...
        || !mOtherParticipantUUID.isNull())
    {
        ...
        if (mInputEditor)
        {
            ...
            if (!text.empty())
            {
                ...
                if ((chat_prefix_support || chat_prefix_testing) && FSData::getInstance()->isWavebreakerGroup(mSessionID))
                {
...
bool FSFloaterIM::postBuild()
{
    ...
    const bool isFSSupportGroup = FSData::getInstance()->isWavebreakerGroup(mSessionID);
