...
LLViewerFolderDictionary::LLViewerFolderDictionary()
{
    ...
    // <FS:Ansariel> Special Wavebreaker folder
    addEntry(LLFolderType::FT_WAVEBREAKER,            new ViewerFolderEntry("Wavebreaker",              "Inv_WavebreakerOpen",    "Inv_WavebreakerClosed",  false,     true));
    addEntry(LLFolderType::FT_WAVEBREAKER_LEGACY,     new ViewerFolderEntry("Wavebreaker Legacy",       "Inv_WavebreakerOpen",    "Inv_WavebreakerClosed",  false,     true));
