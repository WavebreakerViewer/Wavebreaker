...
void LLCrashLogger::gatherFiles()
{
    ...
    mFileMap.erase( "SecondLifeLog" ); // <FS:ND/> Don't send any Wavebreaker.log. It's likely huge and won't help for crashdump processing.
    ...
    // <FS:ND> Might hardcode mCrashHost to crashlogs.wavebreakerviewer.com if unset
...
bool LLCrashLogger::sendCrashLog(std::string dump_dir)
{
    ...
    std::string dump_path = gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "WavebreakerCrashReport");
...
bool LLCrashLogger::init()
{
...
#if ADDRESS_SIZE == 64
    gDirUtilp->initAppDirs( "Wavebreaker_x64" );
#else
    gDirUtilp->initAppDirs("Wavebreaker");
#endif
    ...
    // <FS:ND> Change default to Wavebreaker
    //  mProductName = "Second Life";
    mProductName = "Wavebreaker";
    // </FS:ND>
