...
macro(vcs_get_revision _output_variable)
    ...
    # CPACK framework
    #SET(WAVEBREAKER_PACKAGE_VERSION ${V_MAJOR}.${V_MINOR}.${V_PATCH})

    # Dev build number framework.
    #SET(WAVEBREAKER_DEVELOPMENT_VERSION 1)

    # Show the version number and complete / return to utility script.
    MESSAGE(STATUS "Current Mercurial revision is ${WAVEBREAKER_WC_REVISION}")
    set(${_output_variable} ${WAVEBREAKER_WC_REVISION})
