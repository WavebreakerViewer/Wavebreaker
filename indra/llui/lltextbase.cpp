...
void LLTextBase::createUrlContextMenu(S32 x, S32 y, const std::string &in_url)
{
    ...
    registrar.add("FS.ZoomIn", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/zoom", true));
    registrar.add("FS.TeleportToTarget", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/teleportto", true));
    registrar.add("FS.OfferTeleport", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/offerteleport", true));
    registrar.add("FS.RequestTeleport", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/requestteleport", true));
    registrar.add("FS.TrackAvatar", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/track", true));
    registrar.add("FS.AddToContactSet", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/addtocontactset", true));  // [FS:CR]
    registrar.add("FS.BlockAvatar", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/blockavatar", true));
    registrar.add("FS.ViewLog", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/viewlog", true));
    // </FS:Ansariel>
    ...
    registrar.add("FS.JoinGroup", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupjoin", true));
    registrar.add("FS.LeaveGroup", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupleave", true));
    registrar.add("FS.ActivateGroup", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupactivate", true));
    ...
    registrar.add("FS.AllowGroupChat", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupchatallow", true));
    registrar.add("FS.ForbidGroupChat", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupchatforbid", true));
    registrar.add("FS.EjectGroupMember", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupeject", true));
    registrar.add("FS.BanGroupMember", std::bind(&LLUrlAction::executeSLURL, "secondlife:///app/wavebreaker/" + target_id_str + "/groupban", true));
