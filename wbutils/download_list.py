...
# https://downloads.wavebreakerviewer.org/preview/windows/Wavebreaker-Releasex64-6-6-8-68355_Setup.exe

# MD5: 3094776F5DB11B6A959B0F3AED068C6A

# Windows for SL 32 bit
# https://downloads.wavebreakerviewer.org/preview/windows/Wavebreaker-Release-6-6-8-68355_Setup.exe

# MD5: 2F960B3353971FFF63307B5210D306F5

# Windows for Opensim 64bit
# https://downloads.wavebreakerviewer.org/preview/windows/WavebreakerOS-Releasex64-6-6-8-68355_Setup.exe

# MD5: 6218D7B826538BB956699F9581532ECE

# Windows for Opensim 32bit
# https://downloads.wavebreakerviewer.org/preview/windows/WavebreakerOS-Release-6-6-8-68355_Setup.exe

# MD5: D636CAFD287B4C8B96D726FE2A145327

# -------------------------------------------------------------------------------------------------------
# Mac OSX for SL
# https://downloads.wavebreakerviewer.org/preview/mac/Wavebreaker-Releasex64-6-6-8-68355.dmg

# MD5: DA5AF534690328078B0B7BCEEA8D6959

# Mac OSX for Opensim
# https://downloads.wavebreakerviewer.org/preview/mac/WavebreakerOS-Releasex64-6-6-8-68355.dmg

# MD5: 16CA020E73760D8205E2314D07EEC90E

# -------------------------------------------------------------------------------------------------------
# Linux for SL
# https://downloads.wavebreakerviewer.org/preview/linux/Wavebreaker-Releasex64-6-6-8-68355.tar.xz

# MD5: 1A0C50065077B92889FFBC651E4278E4

# Linux for Opensim
# https://downloads.wavebreakerviewer.org/preview/linux/WavebreakerOS-Releasex64-6-6-8-68355.tar.xz
...
def update_fs_version_mgr(build_info, config):
    print(f"Updating Wavebreaker Version Manager for build_type {build_info['build_type']}")
    ...
    for file_key in build_info["downloadable_artifacts"]:
        ...
        # Make the API call
        url = "https://www.wavebreakerviewer.org/set-fs-vrsns-jsn/"
